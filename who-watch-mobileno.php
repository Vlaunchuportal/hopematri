...
$sql = "select * from register_new where matri_id IN (select to_id from contact_checker where my_id ='".$matri_id."') and gender='$gender' and religion ='".$religion."' ORDER BY CASE WHEN sportlight = 'yes' THEN 0 WHEN sportlight = 'no' THEN 1 ELSE 2 END";
$who_mobiles = mysqli_query($conn, $sql);

$per_page =10;//define how many games for a page
$count = mysqli_num_rows($who_mobiles);
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
          <div class="profile_head">
            <h2 class="text-red">Who watched my mobile number </h2>
            <p>You can check all of Who watched my mobile number list here. </p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-9 col-md-7 col-sm-12 mt-2 pagin_res">
            ...
            <div class="search_result_body">
				<a href="member-profile.php?id=<?php echo $register_details['matri_id']; ?>">
