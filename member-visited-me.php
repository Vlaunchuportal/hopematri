...
$sql = "select * from register_new where matri_id IN (select matri_id from view_my_profile where viewed_member_id ='".$matri_id."') and gender='$gender' and religion ='".$religion."' ORDER BY CASE WHEN sportlight = 'yes' THEN 0 WHEN sportlight = 'no' THEN 1 ELSE 2 END";
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
          <div class="profile_head">
            <h2 class="text-red">My Profile Viewd By </h2>
            <p>You can check all of your My Profile Viewd By members list here. </p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-9 col-md-7 col-sm-12 mt-2 pagin_res">
            <div class="alert alert-info alert-warning" role="alert">
			  ...
			  <article>
				<h4> <i class="fa fa-star gt-text-blue gt-margin-right-10"> </i>Spotlight Profile</h4>
            ...
            <div class="search_result_footer">
              <div class="row d-flex">
                <div class="col-lg-4 col-sm-12 but_accepted_wrap"> 
				<a class="result_btn-w start_chat" href="javascript:void(0);" data-id="<?php echo $register_details['matri_id']; ?>" data-name="<?php echo $register_details['username'] . ' (' . $register_details['matri_id'].')'; ?>"> <i class="fa fa-envelope me-1"> </i> Send Message</a> </div>
