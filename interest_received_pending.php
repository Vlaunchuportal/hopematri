...
$exp_rec_query = mysqli_query($conn,"select * from expressinterest WHERE receiver_id = '".$matri_id."' and receiver_response = 'Pending'");
?>
<style>
            ...
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                ...
                <div class="tab-content" id="pills-tabContent">
					<?php if(mysqli_num_rows($exp_rec_query)) { ?>
					<!--div class="gt-exp-strip gt-margin-top-15 tab_head">
                            <label class="col-lg-1 col-xs-2" for="exp-rec-all-1"><input type="checkbox" name="mul_selected"></label>
                            <div class="col-lg-3 col-md-5 col-xs-6">
                                <a class="btn btn-danger gt-cursor" id="mul_delete_rec"><i class="fa fa-trash gt-margin-right-10"></i>Delete</a>
                            </div>
							<div class="col-lg-3 col-md-5 col-xs-6">
								<a class="btn btn-danger gt-cursor" id="mul_accept_rec"><i class="fa fa-trash gt-margin-right-10"></i>Accept</a>
                            </div>
                    </div-->
					<?php foreach($exp_rec_query as $exp_rec_result){ 
						$query = register_details($religion, $exp_rec_result['sender_id'], $gender);
						$register_details = mysqli_fetch_array($query);
					?>
					<div class="no-data1 mt-3">
                              <div class="gt-interest-rec send_tab" id="<?php echo $exp_rec_result["id"]; ?>">
                                <!--div class="col-xxl-16 col-xl-16 col-sm-16 col-md-16 col-lg-16 hidden-xs hidden-sm hidden-md">
                                  <div class="row">
                                    <label class="col-lg-8 col-md-16 col-xxl-16 col-xl-8 col-xs-16 col-sm-16 gt-margin-bottom-0">
                                       <input type="checkbox" name="single_check_rec[]" class="single_check_rec" value="<?php echo $exp_rec_result["id"]; ?>">
                                    </label>
                                  </div>
                                </div-->
                                <div class="user_img_expwrap row">
                                  <div class="user_img_exp col-lg-2">
                                    <a href="/member-profile.php?id=<?php echo $exp_rec_result['sender_id']; ?>">
                                      <?php  echo $profile_pic = profile_pic(1, $exp_rec_result['sender_id'], $gender); ?>
                                    </a>
                                  </div>
                                  <div class="right_user_dis col-lg-10">
                                    <div class="row">
                                      <div class="col-lg-6 text-center">
                                        <a href="/member-profile.php?id=<?php echo $exp_rec_result['sender_id']; ?>" class="gt-text-black">
                                          <h4 class=""><?php echo $register_details['username'].' ('.$register_details['matri_id'].')'; ?></h4>
                                        </a>
                                      </div>
                                      <div class="col-lg-6 text-center">
                                        <label class="gt-margin-top-10"><?php echo $exp_rec_result['sent_date']; ?></label>
                                      </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                      <div class="col-xxl-16 col-xl-16 col-md-16 col-lg-16 col-sm-16">
                                        <p class="gt-margin-top-0"><?php echo $exp_rec_result['message']; ?></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-xxl-16 col-lg-16 col-xs-16 col-sm-16 col-md-16">
                                  <div class="deletewrap_bottom">
                                    <div class="text-center gt-margin-top-10">
                                      <a class="btn gt-text-green send_msg start_chat" data-id="<?php echo $exp_rec_result['sender_id']; ?>" data-name="<?php echo $register_details['username'].' ('.$register_details['matri_id'].')'; ?>"><i class="fa fa-envelope gt-margin-right-10"></i> Send Message</a>
                                    </div>
                                    <div class="col-lg-4 pull-right but_accepted_wrap gt-margin-top-10">
									<?php if($exp_rec_result["receiver_response"]=='Pending' || $exp_rec_result["receiver_response"]=='Reject'){ ?>
									  <a href="javascript:void(0);" class="btn btn-danger gt-cursor single_accept_send" data-id="<?php echo $exp_rec_result["id"]; ?>" data-name="<?php echo $register_details["username"]; ?>" data-email="<?php echo $register_details["email_id"]; ?>" data-senderID="<?php echo $exp_rec_result["sender_id"]; ?>">
                                        <i class="fa fa-check gt-margin-right-10"></i>Accept
										</a>
									<?php } if($exp_rec_result["receiver_response"]=='Accept' || $exp_rec_result["receiver_response"]=='Pending'){ ?>	
                                      <a href="javascript:void(0);" class="btn btn-danger gt-cursor single_decline_send" data-id="<?php echo $exp_rec_result["id"]; ?>" data-name="<?php echo $register_details["username"]; ?>" data-email="<?php echo $register_details["email_id"]; ?>" data-senderID="<?php echo $exp_rec_result["sender_id"]; ?>">
                                        <i class="fa fa-trash gt-margin-right-10"></i>Decline
                                      </a>
									<?php } ?>
                                    </div>
                                  </div>
